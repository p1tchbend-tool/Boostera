namespace Boostera
{
    public class History
    {
        ...
        public History(string uniqueKey, string searchKey, int protocol, string host, string user, string port, string privateKey, string password, string logonScript,
            bool isForwarding, string forwardingHost, string forwardingUser, string forwardingPort, string forwardingPrivateKey, string forwardingPassword, bool isHide, string tag)
        {
            UniqueKey = uniqueKey;
            SearchKey = searchKey;
            Protocol = protocol;
